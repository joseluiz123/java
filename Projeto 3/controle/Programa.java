...
public class Programa {
	public static void main(String[] args) {
		...
		System.out.print("Digite 1 para Funcionário | 2 para Vendedor | 3 para Diretor: ");
		...
		switch (opcao) {
			...
			case 3:
				...
				System.out.print("Digite o valor da bonificacao: ");
				Float bonificacao = leia.nextFloat();
				
				ControlaDiretor contDir = new ControlaDiretor();
				
				contDir.incluirDiretor(nome, salario, bonificacao);
                contDir.exibeDiretor(); //exibe Diretor e salário com comissão
				break;
			default:
